...
public class User_controller {
    ...
    @RequestMapping(value = "api/table_user", method = RequestMethod.GET)
    public List<User> Get_users(){
        return user_dao.Get_users();
    }

    @RequestMapping(value = "api/table_user/{id}",method = RequestMethod.DELETE)
    public void Delete_users(@PathVariable Long id){
        user_dao.delete_user(id);
    }

    @RequestMapping(value = "api/table_user", method = RequestMethod.POST)
